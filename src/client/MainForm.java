...
public class MainForm extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        sendFileMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F1, java.awt.event.InputEvent.CTRL_MASK));
    ...
    private void sendFileMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendFileMenuActionPerformed
        ...
        if(!attachmentOpen){
            ...
            if(s.prepare(username, host, port, this)){
                ...
                JOptionPane.showMessageDialog(this, "Tidak dapat menggunakan File Sharing pada saat ini, coba lagi nanti.!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
